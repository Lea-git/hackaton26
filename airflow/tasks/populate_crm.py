        ...
        if siren and len(siren) == 9:
            try:
                ...
                if existing:
                    ...
                    logger.info(f"[crm] Fournisseur existant: {entreprise} (id={fournisseur_id})")
                else:
                    ...
                    fournisseur_id = resp.get("data", {}).get("id")
                    stats["fournisseurs_created"] += 1
                    logger.info(f"[crm] Fournisseur créé: {entreprise} (id={fournisseur_id})")
